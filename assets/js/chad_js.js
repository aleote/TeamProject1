...
var nxAppId = "74726c7b",
  ...
  randomMealArray = ["burger", "chicken", "fish", "salad", "fries", "mccafe", "ice cream", "wrap"],
...
function chooseQuery() {
  ...
  // use "ice cream" when calories are 250 or below
    ...
    if ((randomMeal == "salad") || (randomMeal == "mccafe") || (randomMeal == "ice cream")) {
...
function getFood() {
  ...
  $.ajax({
    ...
    function totalNutrition(x) {
      this["finishedMeal" + x + "Calories"] += mealItemCalories;
      this["finishedMeal" + x + "Protein"] += mealItemProtein;
      this["finishedMeal" + x + "Carbs"] += mealItemCarbs;
      this["finishedMeal" + x + "Fat"] += mealItemFat;
    }
...
function displayTotalNutrition(y) {
  ...
  console.log(temp);
  console.log("finishedMeal" + y + " nutrition:");
  console.log("total calories: " + this["finishedMeal" + y + "Calories"]);
  console.log("total protein: " + this["finishedMeal" + y + "Protein"]);
  console.log("total carbs: " + this["finishedMeal" + y + "Carbs"]);
  console.log("total fat: " + this["finishedMeal" + y + "Fat"]);
  console.log("----------");
}
